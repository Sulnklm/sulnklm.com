        ...
        <section className="z-50 lg:px-20">
          <div className="relative lg:gap-20">
            <div className="flex flex-col justify-center mb-3">
              <SubTextBox
                icon={
                  <ArchiveIcon size={15} className="text-orange-400" strokeWidth={1.5} />
                }
              >
                {SELECTED_PROJECTS_CONST.PARAGRAPH}
              </SubTextBox>
              <div className="flex gap-2 items-center justify-center">
                <h2 className="text-center">{SELECTED_PROJECTS_CONST.SELECTED_HEADING1}</h2>
                <h2 className="text-center">{SELECTED_PROJECTS_CONST.SELECTED_HEADING2}</h2>
                <h2 className="text-center font-PerfectlyNineties tracking-normal italic">
                  {SELECTED_PROJECTS_CONST.SELECTED_HEADING3}
                </h2>
              </div>
            </div>
            ...
            <div className="mt-10 grid lg:grid-cols-2 xl:grid-cols-3 gap-5 2xl:gap-10 place-items-center bg-customGray w-full">
              {filteredProjects.length === 0 ? (
                <p className="text-center text-gray-500">No selected projects found.</p>
              ) : (
