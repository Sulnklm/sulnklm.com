  ...
  return (
    ...
    <div className="relative z-[100] w-full h-[60vh] sm:h-[80vh] lg:h-[90vh] pt-20 lg:pt-24 bg-primary dark:bg-black overflow-hidden">
      ...
      <div className="flex justify-center items-center gap-3">
        <h2 className="text-white">{FOOTER_CONST.HEADING1}</h2>
        <PointerHighlight
          rectangleClassName="!border-blue-400 bg-blue-500/10 dark:bg-blue-500/10"
          pointerClassName="text-yellow-500"
        >
          <h2 className="text-white">{FOOTER_CONST.HEADING2}</h2>
        </PointerHighlight>
      </div>
      ...
      <div className="absolute right-0 left-0 bottom-0 bg-primary/5 backdrop-blur-3xl py-2">
        <p className="text-sm text-center !text-grey_scale_800">{FOOTER_CONST.COPYRIGHT1}</p>
      </div>
