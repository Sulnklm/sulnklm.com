...
const badgeColors: Record<string, string> = {
  default: "bg-gray-100 dark:bg-gray-100/10 text-gray-600 dark:text-gray-300 border border-gray-300",
...
export default function ProjectBadge({ children, variant = "default" }: BadgeProps) {
  return (
    <span
      className={
        "px-1.5 py-[2px] rounded-lg text-xs font-[500] inline-block align-middle shadow-inner-customWhite dark:shadow-none " +
