...
export const ListProjectCard = ({ PROJECT }: ListProjectCardPropTypes) => {
  ...
  return (
    <div
      className="group relative shadow-lg rounded-[45px] bg-white dark:bg-primary p-2"
    ...
    >
      ...
      <div className="grid lg:flex justify-between items-center gap-5 lg:gap-20 px-5 pb-5">
        <div className="flex-1 z-10">
          <img
            src={PROJECT.IMAGE.SRC}
            alt={PROJECT.IMAGE.ALT}
            className="object-cover lg:m-10 bg-white dark:bg-primary group-hover:bg-background dark:group-hover:bg-black duration-300 rounded-[40px] w-full h-full border"
          />
        </div>
